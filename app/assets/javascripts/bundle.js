...
var _userApi = __webpack_require__(34);

var API = _interopRequireWildcard(_userApi);
...
exports.fetchUsers = exports.fetchUser = exports.destroyUser = exports.createUser = exports.logout = exports.login = undefined;

var _axios = __webpack_require__(35);

var _axios2 = _interopRequireDefault(_axios);

var _csrfHelper = __webpack_require__(54);

var _csrfHelper2 = _interopRequireDefault(_csrfHelper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var login = exports.login = function login(name, pw) {
  return (0, _axios2.default)({
    method: 'POST',
    url: '/api/session',
    data: { user: { name: name, password: pw } },
    headers: (0, _csrfHelper2.default)()
  });
};
...
var createUser = exports.createUser = function createUser(name, pw) {
  return (0, _axios2.default)({
    method: 'POST',
    url: '/api/users',
    data: { user: { name: name, password: pw } },
...
var destroyUser = exports.destroyUser = function destroyUser(name) {
  return (0, _axios2.default)({
    method: 'DELETE',
    url: '/api/users/' + name,
    headers: (0, _csrfHelper2.default)()
...
var fetchUser = exports.fetchUser = function fetchUser(name) {
  return _axios2.default.get('/api/users/' + name);
};
